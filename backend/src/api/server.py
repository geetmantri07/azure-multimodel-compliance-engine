...
#     title="Compliance Guardian AI API",
#     description="API for auditing video content against compliance rules.",
#     version="1.0.0"
# )
app = FastAPI(
    title="Compliance Guardian AI API",
...
def home():
    ...
    <html>
    <head>
        <title>Compliance Guardian AI</title>
    ...
    <body>
        ...
        <h1>Compliance Guardian AI</h1>
        <p>Video Compliance Audit</p>

        <input id="url" placeholder="Paste YouTube URL here">

        <button onclick="runAudit()">Run Check</button>
